...
-- - student : Arthur Lacombe  id = 16
-- - project : Dicta quia at qui  id = 6
UPDATE student
SET project_id = NULL
WHERE id = 16;
...
-- Exo 2.10
-- Supprimez un project et toutes les relations avec ses dépendances, 
--* c-à-d les relations avec des student  = project_id dans student
--* et les relations avec des tags :      = table project_tab
